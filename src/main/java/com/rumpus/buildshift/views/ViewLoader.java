...
/**
 * ViewLoader is responsible for initializing the primary components of
 * BuildShift views, including Navbar, Footer, Header items, and
 * ResourceManager.
 * <p>
 * All dependencies are injected via Spring, and initialization of
 * instance-dependent components is deferred to a {@link PostConstruct} method
...
public class ViewLoader extends AbstractViews {
     ...
     * injection
     */
    private final String BUILDSHIFT_BRAND;
     ...
     *
     * @param BUILDSHIFT_BRANDThe
     *            brand value from the Spring context, qualified by "navbarBrand".
     */
    @Autowired
    public ViewLoader(@Qualifier("navbarBrand")
    String BUILDSHIFT_BRAND) {
        this.BUILDSHIFT_BRAND = BUILDSHIFT_BRAND;
    }
