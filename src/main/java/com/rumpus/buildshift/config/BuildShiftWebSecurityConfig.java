...
// @Bean
// public SecurityFilterChain buildshiftConfigure(HttpSecurity http) throws
// Exception { // allowing 'ADMIN' access to /api/users
// AuthenticationHandler authHandler = new AuthenticationHandler(null); // TODO:
// look into activeUserStore later.
...
// configuration.setAllowCredentials(true); // Needed if sending cookies/auth
// headers
...
// // return new
// RumpusUserService(this.applicationContext.getBean("rumpusUserDao",
// // IRumpusUserDao.class));
// // }
