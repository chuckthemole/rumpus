...
public class CommonRestController
        extends
            AbstractCommonRestController<RumpusServiceManager, RumpusUser, RumpusUserMetaData, IRumpusUserService, RumpusAdminUserView> {
    ...
    public ResponseEntity<Map<String, String>> getCommonPaths(HttpServletRequest request) {
        ...
        return new ResponseEntity<Map<String, String>>(AbstractCommonController.commonPaths
                .getBasePath(AbstractCommonController.COMMON_REST_API_PATH), HttpStatus.ACCEPTED);
    }

    @GetMapping(value = "/paths/{basePath}")
    public ResponseEntity<Map<String, String>> getPathsFromBasePath(@PathVariable("basePath")
    ...
    // protected ResponseEntity<Boolean> getAuthenticationOfUser(Authentication
    // authentication) {
    // LOG("CommonRestControler::getAuthenticationOfUser()");
    // if(authentication == null) {
    // LOG("CommonRestControler::getAuthenticationOfUser() - authentication is
    // null");
